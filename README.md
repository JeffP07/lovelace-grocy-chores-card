...
| track_chore_as_assigned_user | bool        | **Optional** | `false`  | Tracking a chore will mark it as done by the user assigned to the chore. Cannot be used with `user_id` option.|
